    ...
    <div className="min-h-screen bg-[#f8f9fa] text-neutral-800 font-sans pb-16 relative">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
        ...
        {config.isSupabaseConfigured && dbError && (
          <div className="bg-gradient-to-r from-rose-50 to-orange-50 border border-rose-200 rounded-2xl p-5 mb-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 shadow-sm">
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-neutral-600 mt-1 max-w-xl leading-relaxed">
                  Your server is configured with Supabase credentials, but failed to query the <code className="bg-rose-100/50 px-1 py-0.5 rounded text-rose-800 font-semibold font-mono">products</code> table: <span className="italic text-neutral-700">"{dbError}"</span>. Please verify your table schema is set up in your Supabase project.
                </p>
              </div>
            </div>
          </div>
